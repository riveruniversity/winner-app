...
window.Animations = (function() {
  ...
  function startSwirlAnimation() {
    ...
    const primaryRgb = hexToRgb(window.settings.primaryColor);
    const secondaryRgb = hexToRgb(window.settings.secondaryColor);
  ...
  window.startSwirlAnimation = startSwirlAnimation;
